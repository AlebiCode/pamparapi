    ...
    public class CrosswordLogic : MonoBehaviour
    {
        ...
        public WordObject CurrentSelectedWordObject
        {
            set
            {
                ...
                if(currentSelectedWordObject != null)
                    pamparapiText.text = currentSelectedWordObject.GetWordInfo.clue.ToUpper();
            }
                    ...
                    if(wordObject != null) {
                        if (wordObject.CheckWordCompletion())
                        {
                            ...
                            if (LevelCompleted)
                            {
                                ...
                                AudioManager.instance.PlayCrosswordCorrectWordSound();
                                GameCompletion();
                            }
                            else
                            {
                                AudioManager.instance.PlayCrosswordWonGameSound();
